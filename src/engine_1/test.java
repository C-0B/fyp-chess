...
public class test {
	public static void main(String[] args) {
        ...
        game1.readFEN("rnbqkbnr/pppppppp/8/8/3pp3/p4p2/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
        ...
        for(move move : moves) {
        	...
        	tempGame.readFEN("rnbqkbnr/pppppppp/8/8/3pp3/p4p2/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
