	...
	public JDialogpawnPromotion(int colour) {
		...
		btnQueen.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(colour == 1) 	 { pieceSelected = "Q"; }
				else if(colour == -1){ pieceSelected = "q"; }
				setVisible(false);
				dispose();
			}
		});
		...
		btnKnight.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(colour == 1) 	 { pieceSelected = "N"; }
				else if(colour == -1){ pieceSelected = "n"; }
				setVisible(false);
				dispose();
			}
		});
		...
		btnRook.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(colour == 1) 	 { pieceSelected = "R"; }
				else if(colour == -1){ pieceSelected = "r"; }
				setVisible(false);
				dispose();
			}
		});
		...
		btnBishop.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(colour == 1) 	 { pieceSelected = "B"; }
				else if(colour == -1){ pieceSelected = "b"; }
				setVisible(false);
				dispose();
			}
		});
