...
public class byteMove {
	...
	public byteMove(String startSquareStr, String targetSquareStr) {
	...
	//basic move
	public byteMove(int playerToMove, piece piece, int startSquare, int targetSquare){
	...
	public byteMove(int playerToMove, piece piece, int startSquare, int targetSquare, String capturePiece){
		PLAYER_TO_MOVE = playerToMove;
		PIECE = piece;
		START_SQUARE = startSquare;
		startSquareStr = func.sqIntToStr(START_SQUARE);
	...
	public byteMove(int playerToMove, piece piece, int startSquare, int targetSquare, int enPassant){
		PLAYER_TO_MOVE = playerToMove;
		PIECE = piece;
		START_SQUARE = startSquare;
		startSquareStr = func.sqIntToStr(START_SQUARE);
	...
	public boolean equals(byteMove move2) {
